...
const EMBER_ROUTING_ROUTER_SERVICE_REFRESH = !dependencySatisfies(
  'ember-source',
  '^3.28.0' // TODO: Update this with the correct Ember version
);

export function initialize(application) {
  if (macroCondition(EMBER_ROUTING_ROUTER_SERVICE_REFRESH)) {
